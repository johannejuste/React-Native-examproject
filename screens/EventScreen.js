        ...
        <SafeAreaView style={styles.container}>
            <ScrollView>
                <View style={styles.section1}>
                    ...
                    <Image style={styles.bannerImg} // source={props.event.imageUrl
                    ...
                    <Text style={styles.eventTime}>
                        <Image
                            ...
                            source={require('./../assets/alarm-clock-black.png')}/> {singleEvent.eventTime}
                    </Text>
                    <Text style={styles.eventLocation}>
                        <Image
                            style={styles.tinyLogoLocation}
                            source={require('./../assets/marker-black.png')}/> {singleEvent.eventLocation}
                    </Text>

                    <View style={styles.midSection}>

                        <Image style={styles.mediumLogo} // source={props.event.imageUrl
                        source={require('./../assets/logo.png')}/>
                        <View style={styles.eventTxtWrap}>
                            <Text style={styles.eventSubline}>
                                CBS Students
                            </Text>
                            <Text style={styles.eventSubline2}>
                                View page
                            </Text>
                        ...
                        <View style={styles.blueMsgBox}>
                            ...
                            <Image style={styles.ChatIcon} // source={props.event.imageUrl
                    ...
                    <View style={styles.sectionWrapper}>
                        ...
                        <View style={styles.flexBoxIcons}>
                            <Image style={styles.tinyLogoBlackCalender} // source={props.event.imageUrl
                              source={require('./../assets/blackstar.png')}/>
                            <Text style={styles.eventSubline2BlackInt}>145 Interested</Text>

                            <Image style={styles.tinyLogoBlackStar} // source={props.event.imageUrl
