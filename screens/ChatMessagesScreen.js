...
const ChatMessagesScreen = props => {
    ...
    // console.log(ChatRooms); const chatMessages = ChatRooms.find(room =>
    // room.chatRoomId === id).messages;
    const chatMessages = useSelector(state => state.chat.chatRooms)
        .find(room => room.chatRoomId === id)
        .messages;
    ...
    const handleSend = () => {
        ...
        //dispatch(newChatMessage(id, value)); console.log("value " + value);
    };
            ...
            <View style={styles.messages}>
                <FlatList
                    ...
                    <ChatMessage
                        ...
                        image={require('./../assets/ac99082f65d5c636e14e70785817899e.png')}></ChatMessage>
                )}
