...
const LoginScreen = (props) => {
    ...
    const [email,
        onChangeEmail] = useState("");
    const [password,
        onChangePassword] = useState("");
    ...
    React.useEffect(() => {
        ...
        const bootstrapAsync = async() => {
            ...
            try {
                ...
                if (expiration < new Date()) { // is expired, then refresh
                ...
                if (userToken) {
                    ...
                    dispatch(toggleUserValid(!isValid)); // toggle true
                }
            ...
            <View style={styles.wrapper}>
                ...
                <View style={styles.wrapperInline}>
                    ...
                    <View style={styles.infoIcon}>
                        <TextInput
                            placeholder="sije19ab@cbs.student.dk"
                            label="Email"
