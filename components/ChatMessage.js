...
const ChatMessage = props => {
    ...
    // console.log("------------------"); console.log(props.chatmessage);
    ...
    // console.log("----------------: " + props.img); only display the image if this
    // message is not written by me.
    let image;
    if (!isMe) {
    ...
    return (
        ...
        <View style={styles.outerContainer}>
            <View
                ...
                <View
                    style={[
                    styles.messageView, isMe
                        ? styles.messageViewFromMe
                        : ''
                ]}>
                    <Text
                        style={[
